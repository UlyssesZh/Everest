...
case "$1" in
    "Celeste")
        TAS_URL="https://github.com/VampireFlower/CelesteTAS/archive/1c0ef5a0eae89ce946a1e9517f0915d8e5533bf3.zip"
        TAS_PATH="CelesteTAS-1c0ef5a0eae89ce946a1e9517f0915d8e5533bf3/0 - 100%.tas"
        ;;
